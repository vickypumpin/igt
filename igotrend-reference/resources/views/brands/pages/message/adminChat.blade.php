            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div class="flex">
                            <form method="post" action="{{route('brand_admin_send_msg')}}" class="ajax-form">
                                @csrf
                                ...
                                <div class="px-3 form-group mb-0">
                                    <div class="input-group input-group-merge input-group-rounded flex-nowrap">
                                        <select id="custom-select" class="form-control custom-select campaign_select">
                                            <option selected value="" data-url="{{route('brand_admin_chat',[$receiver])}}">More Campaigns</option>
                                            @foreach($campaigns as $campaign)
                                                <option value="{{$campaign->id}}" @if($campaign_id == $campaign->id) selected @endif data-url="{{route('brand_admin_chat',[$receiver,'campaign_id'=>$campaign->id])}}">{{$campaign->name}}</option>
                                            @endforeach
                                        </select>
