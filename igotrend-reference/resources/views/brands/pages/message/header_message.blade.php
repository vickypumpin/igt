...
@if($is_admin)
    <a href="{{route('brand_admin_chat',$admin_message->from_user)}}" class="list-group-item list-group-item-action unread">
        @else
            <a href="{{route('brandChatIndex',$message->from_user)}}" class="list-group-item list-group-item-action unread">
        @endif
