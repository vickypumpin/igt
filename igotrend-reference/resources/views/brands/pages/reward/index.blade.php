                ...
                <div class="py-32pt navbar-submenu">
                    <div class="container-fluid page__container">
                        <div class="progression-bar progression-bar--active-accent">
                            ...
                            <a href="{{route('brand_reward_contacts')}}" class="progression-bar__item progression-bar__item--complete progression-bar__item--active">
                            <span class="progression-bar__item-content">
                ...
                <div class="py-32pt py-lg-64pt">
                    <div class="container-fluid page__container">
                        <div class="col-lg-08 p-0 mx-auto">
                            <form method="post" action="{{route('pay_reward')}}">
                                @csrf
                                <div class="row">
                                            ...
                                            <div class="form-group row align-items-center mb-0">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control custom-select" name="campaign"  id="campaign" >
                                                        ...
                                                        @foreach($brand_campaigns as $campaign)
                                                            <option value="{{$campaign->id}}" data-url="{{route('get_brand_campaign_users',$campaign)}}">{{$campaign->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
...
@push('page-scripts')
    ...
    <script>
        ...
        $("#contacts").DataTable({
            ...
            // scrollX: true,
            "ajax": {
                "url": '{{ route('brand_get_reward_data') }}',
                "data": function ( d ) {
