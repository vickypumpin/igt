...
@section('content')
    <div class="container-fluid page__container">
        <form action="{{route('brand_account_update_info',auth()->user()->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="list-group list-group-form">
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" value="{{auth()->user()->company_name}}" placeholder="company name" >
                                        @error('company_name')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{auth()->user()->email}}" placeholder="email address" >
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="custom-select" class="form-control custom-select @error('company_size') is-invalid @enderror" name="company_size">
                                            ...
                                            <option value="1-5" @if(auth()->user()->company_size == "1-5") selected @endif>1 - 5</option>
                                            <option value="6-10" @if(auth()->user()->company_size == "6-10") selected @endif>6 - 10</option>
                                            <option value="11-50" @if(auth()->user()->company_size == "11-50") selected @endif>11-50</option>
                                            <option value="51-100" @if(auth()->user()->company_size == "51-100") selected @endif>51-100</option>
                                            <option value="100+" @if(auth()->user()->company_size == "100+") selected @endif>100+</option>
                                        </select>
                                        @error('company_size')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-9">
                                        <select id="custom-select" class="form-control custom-select @error('company_type') is-invalid @enderror" name="company_type">
                                            ...
                                            @foreach($company_types as $type)
                                                <option value="{{$type->id}}" @if(auth()->user()->company_type == $type->id) selected @endif>{{$type->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('company_type')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="country" id="country" class="form-control custom-select @error('country') is-invalid @enderror"  data-url="{{route('getCountriesStates')}}">
                ...
                <div class="col-lg-3 page-nav">
                    <div class="page-section pt-lg-112pt">
                        <nav class="nav page-nav__menu">
                            <a class="nav-link {{ active_class('brand_edit_account') }}" href="{{route('brand_edit_account')}}">Basic Information</a>
                            <a class="nav-link {{ active_class('brand_edit_password') }}" href="{{route('brand_edit_password')}}">Change Password</a>
                        </nav>
