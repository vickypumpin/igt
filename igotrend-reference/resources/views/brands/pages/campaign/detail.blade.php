...
@section('page_route','Campaign Mgt / Campaign Detail')
@section('content')
        ...
        <div class="container-fluid page__container">
            <ul class="nav navbar-nav w-100">
                <li class="nav-item navbar-list__item py-16pt py-sm-0">
                    <a href="{{route('my_campaigns')}}" class="nav-link" >
                ...
                {{--                        --}}{{--                            <a href=""><img src="assets/images/paths/angular_64x64.png" width="40" alt="Angular" class="rounded"></a>--}}
                {{--                        --}}{{--                        </div>--}}
                {{--                        <div class="media-body">--}}
                {{--                            <a href="" class="card-title text-body mb-0">CornFlakes Advert</a>--}}
                {{--                            <p class="lh-1 d-flex align-items-center mb-0">--}}
                {{--                                <span class="text-50 small font-weight-bold mr-8pt">Elijah Murray</span>--}}
                {{--                                <span class="text-50 small">Head of Marketing</span>--}}
                {{--                            </p>--}}
                {{--                        </div>--}}
                {{--                    </div>--}}
                {{--                </li>--}}
                <li class="nav-item navbar-list__item py-16pt py-sm-0">
                    <div class="row" role="tablist">
                        <div class="col-auto d-flex flex-column">
                            <h6 class="m-0">
                                <img src="{{asset('images/nairalogo.png')}}" alt="n" class="flex">&nbsp; {{number_format($budget,3)}}</h6>
            ...
            <div class="col-lg-3 page-nav">
                <div class="page-section pt-lg-112pt">
                    <nav class="nav page-nav__menu">
                        ...
                        @if($campaign->status != \App\Models\Campaign::ACTIVE && $campaign->status != \App\Models\Campaign::COMPLETED)
                            <a class="nav-link" href="{{route('edit_campaign',$campaign)}}">
                                <button type="button" class="btn btn-secondary">
                                    <i class="material-icons icon--left">edit   </i> Edit
                                </button>
                            </a>
                        @endif

                        @if($campaign->is_disable == \App\Models\Campaign::ENABLE)
                            <a class="nav-link" href="{{route('disableCampaign',$campaign)}}"   >
                                <button type="button" class="btn btn-danger" >
                                    <i class="material-icons icon--left" >block</i> Disable
                                </button>
                            </a>
                        @else
                            <a class="nav-link" href="{{route('enableCampaign',$campaign)}}"   >
                                <button type="button" class="btn btn-info" >
                                    <i class="material-icons icon--left" >check</i> Enable
                                </button>
                            </a>
                        @endif

                        <a class="nav-link" href="{{route('brand_campaign_complete',$campaign)}}">
                            <button type="button" class="btn btn-warning" >
                                <i class="material-icons icon--left" >approval</i> Completed
                            </button>
                        </a>
                    </nav>
