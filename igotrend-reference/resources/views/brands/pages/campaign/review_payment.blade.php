        ...
        <div class="py-32pt navbar-submenu">
            <div class="container-fluid page__container">
                <div class="progression-bar progression-bar--active-accent">
                    ...
                    <a href="{{route('add_trenders',$campaign)}}" class="progression-bar__item progression-bar__item--complete">
                            <span class="progression-bar__item-content">
                                <i class="material-icons progression-bar__item-icon">done</i>
                                <span class="progression-bar__item-text h5 mb-0 text-uppercase">Add Trenders</span>
                            </span>
                    </a>
                    <a href="{{route('review_payment',$campaign)}}" class="progression-bar__item progression-bar__item--complete progression-bar__item--active">
                            <span class="progression-bar__item-content">
    ...
    <nav class="navbar navbar-expand-sm navbar-list border-bottom-2  py-sm-16pt">
        <div class="container-fluid page__container">
            <ul class="nav navbar-nav w-100">
                ...
                <li class="nav-item navbar-list__item py-16pt py-sm-0">
                    <div class="media">
                        <form method="post" action="{{route('pay-campaign',$campaign)}}">
                            @csrf
                ...
                <li class="nav-item navbar-list__item py-16pt py-sm-0">
                    <div class="row" role="tablist">
                        <div class="col-auto d-flex flex-column">
                            <h6 class="m-0"><img src="{{asset('images/nairalogo.png')}}" alt="n" class="flex">&nbsp;
                                {{number_format($estimated_budget,3)}}
                            </h6>
