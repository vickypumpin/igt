        ...
        $( ".camp_tab" ).on( "click", function() {
            ...
            if (tab_target === 'PendingCamp'){
                ...
                $("#completed_campaigns").DataTable({
                    ...
                    responsive: true,
                    // scrollX: true,
                    ajax: '{{ route('completed_campaigns') }}',
                    columns: [
                        {data: 'project', name: 'project'},
                        {data: 'sponsor', name: 'sponsor'},
                        {data: 'status', name: 'status'},
