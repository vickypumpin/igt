        ...
        <div class="container-fluid page__container">
            <ul class="nav navbar-nav w-100">
                <li class="nav-item navbar-list__item py-16pt py-sm-0">
                    <a href="{{route('manage_admin_campaigns')}}" class="nav-link" >
                ...
                {{--                            <a href="" class="card-title text-body mb-0">{{$campaign->name}}</a>--}}
                {{--                            <p class="lh-1 d-flex align-items-center mb-0">--}}
                {{--                                <span class="text-50 small font-weight-bold mr-8pt">{{$campaign->owner->first_name ." ".$campaign->owner->last_name}}</span>--}}
                {{--                            </p>--}}
                {{--                        </div>--}}
                {{--                    </div>--}}
                {{--                </li>--}}
            ...
            <div class="col-lg-3 page-nav">
                <div class="page-section pt-lg-112pt">
                    <nav class="nav page-nav__menu">
                        <a class="nav-link" href="{{route('manage_admin_campaigns')}}">
                        ...
                        <a class="nav-link" href="{{route('campaign_approve',$campaign)}}">
                            <button type="button" class="btn btn-success" >
                                <i class="material-icons icon--left" >check</i> Approve
                            </button>
                        </a>
                        <a class="nav-link" href="{{route('campaign_declined',$campaign)}}">
                            <button type="button" class="btn btn-primary" >
                                <i class="material-icons icon--left" >cancel</i> Declined
                            </button>
                        </a>
                        <a class="nav-link" href="{{route('campaign_complete',$campaign)}}">
