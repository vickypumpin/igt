        ...
        <div class="py-32pt navbar-submenu">
            <div class="container-fluid page__container">
                <div class="progression-bar progression-bar--active-accent">
                    <a href="{{route('manage_create_campaign')}}" class="progression-bar__item progression-bar__item--complete progression-bar__item--active">
        ...
        <div class="card card-body mb-32pt">
            <div class="row">
                ...
                <div class="card-body align-items-center">
                    <form class="flex" method="post" action="{{route('manage_create_campaign_save')}}" enctype="multipart/form-data">
                        @csrf
