...
@section('content')
        ...
        <div class="py-32pt navbar-submenu">
            <div class="container-fluid page__container">
                <div class="progression-bar progression-bar--active-accent">
                    ...
                    <a href="{{route('manage_add_trenders',$campaign)}}" class="progression-bar__item progression-bar__item--complete progression-bar__item--active">
                            <span class="progression-bar__item-content">
    ...
    <div class="container-fluid page__container page-section">
        ...
        <div class="row">
            <div class="col-12">
                <form method="post" action="{{route('manage_add_trenders_save',$campaign)}}" id="campaign_mode_form">
                    @csrf
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form method="get" action="{{route('manage_add_trenders',$campaign)}}" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-auto">
                                    <div class="form-group">
                                        ...
                                        <select id="filter_country" name="filter_country" class="custom-select" data-url="{{route('getStates')}}" style="width: 100px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <a href="#" class="btn btn-sm btn-secondary view_trender_info"
                                               data-url="{{route('getCampaignUserInfo',[$trender,$campaign])}}" >
                                                <i class="fa fa-eye icon--center"></i>
                                            </a>
                                            @if(in_array($trender->id,$campaign_users))
                                                <a href="{{route('adminRemoveCampaignUser',[$trender,$campaign])}}" class="btn btn-sm btn-light" >
                                                    <i class="fa fa-user-minus icon--center"></i>
                                                </a>
                                            @else
                                                <a href="{{route('adminAddCampaignUser',[$trender,$campaign])}}" class="btn btn-sm btn-light">
