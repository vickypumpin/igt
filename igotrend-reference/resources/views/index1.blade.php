...
@section('content')
    ...
    <div class="pt-xl-12 pb-xl-15 pb-12 pt-5 v-div pumpinv" style="margin-bottom: 50px;">
        <div class="container header-content">
            ...
            <div class="row  bg-shape">
                <!-- pagecaption start -->
                <div class="offset-xl-1 col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top: 150px" >
                    <div class="py-xl-12 py-8 text-center div-content" data-aos="fade-up ">
                        ...
                        <form  method="GET"  action="{{route('explore')}}">
                            <div class="form-row mx-3">
                                ...
                                {{--                                <div class="form-group col-md-6">--}}
                                {{--                                    <select class="custom-select" name="content_category" required style="color: black; background-color: white; height: 43px !important; padding: 9px !important;">--}}
                                {{--                                        <option selected value="">Choose Content Category</option>--}}
                                {{--                                        @foreach($content_categories as $content_category)--}}
                                ...
                                {{--                                    <select class="custom-select" name="creator_category" style="color: black; background-color: white; height: 43px !important; padding: 9px !important;">--}}
                                {{--                                        <option selected value="">Choose Creator Category</option>--}}
                                {{--                                        @foreach($creator_categories as $creator_category)--}}
                                {{--                                            <option value="{{$creator_category->id}}">{{$creator_category->name}}</option>--}}
                                {{--                                        @endforeach--}}
                                {{--                                    </select>--}}
                                {{--                                </div>--}}
                            ...
                            <div class="slider mt-2 mb-5">
                                @foreach($random_creator_categories as $random_creator_category)
                                    ...
                                    <div class="slide">
                                        ...
                                        <span class="text-dark">{{ucfirst($random_creator_category->name)}}</span>
                                    </div>
                                @endforeach
                                @foreach($random_content_categories as $random_content_category)
                                    ...
                                    <div class="slide">
                                        ...
                                        <span class="text-dark">{{ucfirst($random_content_category->name)}}</span>
                                    </div>
                                @endforeach
    ...
    <div class="pb-xl-4 pb-8">
                    ...
                    <div class="card mt-n8 uplift mb-8 bg-secondary" style="background-image: url({{asset('images/bgpolygon3.png')}});background-repeat: no-repeat;background-attachment: inherit;background-size: cover;">
                        <div class="card-body p-5 text-center">
                            ...
                            <p class="mb-4" style="font-weight: bolder; color: black;">
                                IGT allows advertisers to find,connect and collaborate with the right influencers or creators, giving you the highest engagement rate and best ROI possible coupled with better analytics and reporting.
                            </p>
                        </div>
                    </div>
                    <!-- feature block close -->
        ...
        <h3 class="mb-2 text-center"><u><strong><br>..We mean it, when we say "You Get Value for your Money!"</strong></u></h3>
    </div>
                ...
                <div class="offset-xl-1 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="mb-5" data-aos="fade-up">
                        ...
                        <div class="">
                            ...
                            <p>Get paid for your creativity and unique voice. Join the IGoTrend marketplace and bid on opportunities or get hired by top brands and agencies.</p>
                        </div>
                    </div>
                    <div class="mb-5" data-aos="fade-up">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="card card-body py-5 px-4 mb-4 border-lightinfo" data-aos="zoom-in">
                        <div class="mb-3 text-center">
                            ...
                            <p class="font-12">Best data driven and AI powered platform.</p>
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="card card-body py-5 px-4 mb-4 border-lightpeach" data-aos="zoom-in">
                        <div class="mb-3 text-center">
                            ...
                            <p class="font-12">We serve these sets and we do it well.</p>
                        </div>
                        <div class="text-center">
                            <div class="d-flex mb-2">
                                <!-- Check -->
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="card card-body py-5 px-4 mb-4 border-primary shadow" data-aos="zoom-in">
                        <div class="mb-3 text-center">
                            ...
                            <p class="font-12">Curated features to bring out the best in you</p>
                        </div>
                        <div class="text-center">
                            <div class="d-flex mb-2">
                                <!-- Check -->
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class=" text-center mb-13">
                        <h2>Collaborate with hundreds of brands today!</h2>
