...
@section('content')
    <div class="container-fluid page__container">
        <form action="{{route('update_social_profile')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex" style="min-width: 180px">
                                    <small class="text-black-100">
                                        <strong>Alert! - </strong> Editing these field(s) will automatically lock your account until your input(s) are reviewed by our admin
                                    </small>
                                </div>
                            </div>
                        </div>
                        <div class="list-group list-group-form">
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="user_name" class="form-control @error('user_name') is-invalid @enderror " value="{{auth()->user()->user_name}}" placeholder="profile name">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="content_category" name="content_category[]"  multiple class="form-control content-category-select @error('content_category') is-invalid @enderror" >
                                            @foreach($content_categories as $category)
                                                <option value="{{$category->id}}" @if(in_array($category->id,explode(',',auth()->user()->content_category))) selected @endif>{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="col-sm-9">
                                            <select id="creator_category" name="creator_category[]"  multiple="" class="form-control creator-category-select" >
                                                @foreach($creator_categories as $category)
                                                    <option value="{{$category->id}}" @if(in_array($category->id,explode(',',auth()->user()->creator_category))) selected @endif>{{$category->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="facebook_profile" name="facebook_profile" class="form-control form-control-prepended @error('facebook_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->facebook_profile}}" >
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="instagram_profile" name="instagram_profile" class="form-control form-control-prepended @error('instagram_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->instagram_profile}}" >
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="twitter_profile" name="twitter_profile" class="form-control form-control-prepended @error('twitter_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->twitter_profile}}" >
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="youtube_profile" name="youtube_profile" class="form-control form-control-prepended @error('youtube_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->youtube_profile}}" >
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="tiktok_profile" name="tiktok_profile" class="form-control form-control-prepended @error('tiktok_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->tiktok_profile}}" >
                            ...
                            <div class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="input-group input-group-merge col-sm-9">
                                        <input type="text" id="snapchat_profile" name="snapchat_profile" class="form-control form-control-prepended @error('snapchat_profile') is-invalid @enderror" placeholder="" value="{{auth()->user()->snapchat_profile}}" >
                ...
                <div class="col-lg-3 page-nav">
                    <div class="page-section pt-lg-112pt">
                        ...
                        <div class="page-nav__content">
                            <button type="submit" class="btn btn-accent" @if(auth()->user()->is_account_info_locked == \App\Models\User::ACCOUNT_INFO_LOCKED) disabled @endif>Update Now</button>
                        </div>
                    </div>
                </div>
            </div>
