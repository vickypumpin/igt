                    ...
                    <div class="card card-body">
                        <div class="d-flex">
                            ...
                            <div class="flex">
                                ...
                                <small class="form-text text-muted"> Media Files - <strong style="background-color:tomato;color: white;">Download the below image(s) to be posted with the captions & handles</strong></small>
            ...
            <div class="col-lg-3 page-nav">
                <div class="page-section pt-lg-112pt">
                    <nav class="nav page-nav__menu">
                        <a class="nav-link" href="{{route('discover')}}">Go back</a>
                        <a class="nav-link active" href="#">Brief</a>
