...
import {
  ...
  ChevronDown, Shield, MessageSquare, HelpCircle, FileText, Bell, BarChart2, Menu, X, ShieldAlert,
} from "lucide-react";
    ...
    <div className="flex h-screen bg-background overflow-hidden" data-testid="layout-admin">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
          ...
          <NavLink href="/admin/fraud-panel" icon={ShieldAlert} label="Flagged Accounts" activeColor={ORANGE} activeBg={ORANGE_BG} activeBorder={ORANGE_BORDER} />
